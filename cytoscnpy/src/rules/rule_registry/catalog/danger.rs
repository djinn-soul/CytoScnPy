...
pub(crate) static DANGER_RULES: &[RuleDescriptor] = &[
    ...
    rule(
        ids::RULE_ID_MCP_STDIO,
        RuleCategory::Danger,
        RuleSeverity::Critical,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_CSRF_EXEMPT,
        RuleCategory::Danger,
        RuleSeverity::High,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_LDAP_INJECTION,
        RuleCategory::Danger,
        RuleSeverity::High,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_XPATH_INJECTION,
        RuleCategory::Danger,
        RuleSeverity::High,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_PRIV_ESCALATION,
        RuleCategory::Danger,
        RuleSeverity::High,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_LOG_INJECTION,
        RuleCategory::Danger,
        RuleSeverity::Medium,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_HARDCODED_CREDS,
        RuleCategory::Danger,
        RuleSeverity::High,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_RACE_CONDITION,
        RuleCategory::Danger,
        RuleSeverity::Medium,
        DOC_DANGEROUS_CODE,
    ),
    rule(
        ids::RULE_ID_PYNACL_LOWLEVEL,
        RuleCategory::Danger,
        RuleSeverity::High,
        DOC_DANGEROUS_CODE,
    ),
